...
session_start();
require "header.php";
require ('/opt/lampp/htdocs/cedcab_app-main/ride_class.php');
?>
<!doctype html>
<html>
<head>
    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
                ...
                <td>
                <?php print_r($_SESSION['luggage']); ?>
                </td>

                <td>
                <?php print_r($_SESSION['distance']); ?>
                </td>
            </tr>
    ...
    <a href="invoice.php?p=2" type="button" class="btn btn-danger" onclick="alert('booking has been cancelled')">Cancel</a>
            ...
            <?php
                if(isset($_GET['p'])){
                    ...
                    $users= new RIDE();
                  $sql=$users->ride_data($_SESSION['from'],$_SESSION['to'],$_SESSION['distance'],$_SESSION['luggage']
                ,$_SESSION['fare'],$_SESSION['id'],$_SESSION['class']);
                   //insertion in the table  ride
